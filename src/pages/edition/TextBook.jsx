          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="pt-4">
                ...
                <br />
                <p className="mb-4 text-[#E98121] font-bold text-lg">
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <p className="my-4 text-[#E98121] font-bold text-lg">
                    দ্বীনী আলোচনার উদ্দেশ্য ও ফায়েদা
                  </p>
                  <p className="text-lg leading-relaxed mb-4">
                    দ্বীনী আলোচনা কেবল নতুন বিষয় জানার জন্য নয়। কারো জন্য কোনো
                    কথা নতুন হতে পারে। কোনো নতুন কথা জানা ছাড়াও দ্বীনী আলোচনার
                    আরো ফায়েদা আছে। যেমন-
                  </p>
                  <p className="my-4 text-lg">
                    <span className="font-bold">ক)</span> কোনো অস্পষ্ট বিষয় আরো
                    স্পষ্টভাবে জানা।
                  </p>
                  <p className="my-4 text-lg">
                    <span className="font-bold">খ)</span> কোনো অস্পষ্ট বিষয় আরো
                    কোনো বিষয়ে ভুল বা অসম্পূর্ণ জানলে তার সঠিক ও পূর্ণ জ্ঞান লাভ
                    করা।
                  </p>
                  <p className="my-4 text-lg">
                    <span className="font-bold">গ)</span> আমলের আগ্রহ সৃষ্টি
                    হওয়া।
                  </p>
                  <p className="my-4 text-lg">
                    <span className="font-bold">ঘ)</span> সবচেয়ে বড় ফায়েদা হল
                    ঈমান তাজা হওয়া।
                  </p>
                  <p className="text-lg leading-relaxed mb-4">
                    দ্বীনী মজলিস যে কোনো সময় ও যে কোনো স্থানে হতে পারে। তবে শর্ত
                    হল, কথাগুলো সঠিক ও শুদ্ধ হওয়া।
                  </p>
                  <p className="my-4 text-[#E98121] font-bold text-lg">
                    জুমাপূর্ব বয়ান প্রসঙ্গ
                  </p>
